...
class Wprentals_Recent_Items_Slider_v1 extends Widget_Base {
	...
	public function get_name() {
            return 'Wprentals_Recent_Items_Slider_v1';
	}
	...
	public function get_title() {
		return __( 'WpRentals Recent Item Slider v1', 'rentals-elementor' );
	}
		             ...
		             $this->add_responsive_control(
		                 ...
		                 [
							 ...
							 $this->add_responsive_control(
						 							'owner_thumb_padding',
						 							[
						 									'label'      => esc_html__( 'Owner Thumb position(only left & top)', 'rentals-elementor' ),
						 									'type'       => Controls_Manager::DIMENSIONS,
						 									'size_units' => [ 'px', '%', 'em' ],
						 									'selectors'  => [

						 											'{{WRAPPER}} .owner_thumb' => 'left: {{LEFT}}{{UNIT}};top: {{TOP}}{{UNIT}};',
		                         ...
		                         [
		                             'label'      => esc_html__( 'Property Price position(only right & bottom)', 'rentals-elementor' ),
		                             'type'       => Controls_Manager::DIMENSIONS,
		                             'size_units' => [ 'px', '%', 'em' ],
		                             'selectors'  => [

																		 '{{WRAPPER}} .price_unit' => 'right: {{RIGHT}}{{UNIT}};bottom: {{BOTTOM}}{{UNIT}};',
